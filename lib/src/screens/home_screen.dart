import 'package:battery/src/services/device_battery_channel.dart';
          ...
          children: [
            Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    double batteryLevel = await DeviceBatteryChannel.getBatteryLevel();
                    setState(() {
            ...
            Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    bool isBatteryCharging = await DeviceBatteryChannel.isBatteryCharging();
                    setState(() {
            ...
            Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    String timeLeft = await DeviceBatteryChannel.getBatteryTimeLeft();
                    setState(() {
                      _timeLeft = timeLeft;
                    });
                  },
